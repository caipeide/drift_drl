...
if __name__ == "__main__":
    ...
    os.makedirs('./test/sac-stg2/DF/',exist_ok=True)
    save_path = './test/sac-stg2/DF/DF_M1800'
    save_file = open(save_path + '.csv','w')
    writer = csv.writer(save_file)
    writer.writerow(headers)

    env.reset(traj_num=6, testFlag=True, test_friction=3.5, test_mass=1800, differentFriction=True)
