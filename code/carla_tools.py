...
class World(object):
    ...
    def tick(self, clock, e_dis, e_heading, slip_angle):
        self.hud.tick(self, clock, e_dis, e_heading, slip_angle)
...
class HUD(object):
    ...
    def tick(self, world, clock, e_dis, e_heading, slip_angle):
        ...
        if self._show_info:
            ...
            for item in self._info_text:
                ...
                if item:  # At this point has to be a str.
                    if  item =='Map' or item =='Heading' or item =='Speed' or item == 'C.T.E.' or item == 'H.A.E.' or item == 'Slip Angle' or item == 'Throttle' or item == 'Steer':
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        # self._camera_transforms = [
        #     carla.Transform(carla.Location(x=0, z=30), carla.Rotation(pitch = -70)),
        #     carla.Transform(carla.Location(x=1.6, z=1.7))]
